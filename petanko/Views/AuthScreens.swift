...
private struct TermsOfServiceSheet: View {
    ...
    private var termsText: String {
        """
        この利用規約は、petankoを安心して使うための基本的な約束です。

        1. ユーザーは、自分が投稿する写真、コメント、プロフィール情報について責任を持つものとします。

        2. 他人を傷つける内容、権利を侵害する内容、不適切な画像や文章の投稿は禁止します。

        3. 友達やグループで共有された内容を、相手の許可なく外部へ公開しないでください。

        4. アプリの安定した運営や安全性を妨げる行為は禁止します。

        5. 運営上必要な場合、サービス内容を変更、停止、または利用制限することがあります。

        6. 正式な利用規約文面が定められた場合、この画面の内容は更新されます。
