                            ...
                            Slider(
                                value: Binding(
                                    ...
                                    set: {
                                        draft.updateCrop(
                                            scale: $0,
                                            imageAspectRatio: originalImage.petankoAspectRatio
                                        )
                                    }
                                ),
                                in: 1...2.8
...
private struct StickerComposerPreview: View {
        ...
        DragGesture()
            .onChanged { value in
                ...
                draft.updateCrop(
                    ...
                    imageAspectRatio: image.petankoAspectRatio
                )
            }
            .onEnded { _ in
                cropDragStart = nil
    ...
    private func aspectFitSize(for image: UIImage, in bounds: CGSize) -> CGSize {
        ...
        let aspectRatio = image.petankoAspectRatio
...
private extension UIImage {
    var petankoAspectRatio: CGFloat {
