...
extension Date {
    ...
    nonisolated var petankoDisplayDate: String {
        let formatter = DateFormatter()
        formatter.locale = Locale(identifier: "ja_JP")
    ...
    nonisolated var petankoShortTitle: String {
        let formatter = DateFormatter()
        formatter.locale = Locale(identifier: "ja_JP")
...
extension UIImage {
    ...
    func petankoResized(maxDimension: CGFloat) -> UIImage {
        guard let cgImage,
